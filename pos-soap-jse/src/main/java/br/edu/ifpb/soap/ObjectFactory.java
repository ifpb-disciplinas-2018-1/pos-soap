 ...
 * generated in the br.edu.ifpb.soap package. 
...
public class ObjectFactory {
    ...
    private final static QName _Somar_QNAME = new QName("http://soap.ifpb.edu.br/", "somar");
    private final static QName _SomarResponse_QNAME = new QName("http://soap.ifpb.edu.br/", "somarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.edu.ifpb.soap
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.ifpb.edu.br/", name = "somar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.ifpb.edu.br/", name = "somarResponse")
